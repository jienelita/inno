...
import { Avatar, Col, GetProps, Input, Modal, Row, Tooltip } from 'antd';
...
const Dashboard = ({ disaproved_res, balance_account, image_name }: Props) => {
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                {user?.is_active === 1 ? (
                    <>
                        ...
                        <UpdateUser user_details={user} image_name={image_name} />
                    </>
                ) : (
                    <Row gutter={[16, 16]}>
                        <Col span={6}>
                            <Deposits account={balance_account} />
                        </Col>
                        <Col span={18}>
                            <div className="border-sidebar-border/70 dark:border-sidebar-border relative min-h-[100vh] overflow-hidden rounded-xl border md:min-h-min">
                                <div className="p-4 md:p-4">
                                    <div className="bg-center bg-cover bg-no-repeat hero-bg">
                                        <div className="kt-container-fixed">
                                            <div className="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
                                                ...
                                                <div className="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
                                                    <div className="flex gap-1.25 items-center">
                                                        <i className="ki-filled ki-abstract-41 text-muted-foreground text-sm">
                                                        </i>
                                                    ...
                                                    <div className="flex gap-1.25 items-center">
                                                        <i className="ki-filled ki-geolocation text-muted-foreground text-sm">
                                                        </i>
                                                        <span className="text-secondary-foreground font-medium">
                                                            Members Id: {user?.id}
                                                        </span>
                                            ...
                                            {user?.email_verified_at === null && (
                                                <EmailVerification title='Email address not verify.' children='Please verify your email address.' showDetails={true} />
                                            )}
